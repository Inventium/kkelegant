...
$kk_options_file = 'singleoption.php';
...
function kk_add_theme_admin_small() {
  ...
  //$pagehook = add_options_page("KK Single Option (T)", "KK Single Option (M)", 'administrator', basename(__FILE__), 'kk_pricing_admin_small');
  //$pagehook = add_theme_page("KK Small Options (T)", "KK Small Options (M)", 'administrator', $kk_options_file, 'kk_pricing_admin_small');
  $pagehook = add_theme_page("KK Small Options (T)", "KK Small Options (M)", 'administrator', basename(__FILE__), 'kk_pricing_admin_small');
  add_action('load-'.$pagehook,'kk_admin_init_small');
  // Check this out: uncomment and watch this blow up!
  //echo $pagehook;
}
